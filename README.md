...
> **難しいタスクについて**
>
> Wooden Staff：Ash Wood x 4 + Wooden Stick x 1（右下Equipmentsから装備解除で入手）
>
...
## 3. 会話・推論フェーズのルール
タスク遂行中、チャット画面を通じてパートナーと会話を行います。図2に示すように、テキストボックスが「**緑**」で囲われているタイミングに、操作をお願いします。以下のルールに従って会話してください。

![会話・推論フェーズ](public/images/green.png)
*図2：会話・識別フェーズ*
